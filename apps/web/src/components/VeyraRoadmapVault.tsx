...
export function VeyraRoadmapVault() {
  return (
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 bg-[#0a0a0a] border border-white/10 rounded-3xl p-8 relative overflow-hidden">
          <div className="flex items-center justify-between mb-10">
            <div>
              <h3 className="text-xl font-bold uppercase tracking-widest italic">Roadmap Reserve</h3>
              <p className="text-[10px] text-slate-500 font-mono">MODE: LOCAL_FOUNDATION</p>
            </div>
          ...
          <div className="grid sm:grid-cols-3 gap-8 mb-10">
            {[
              { label: "Mock Reserve", val: "$42.2K", icon: Landmark },
              { label: "Tracked Assets", val: "12 VRA", icon: Coins },
              { label: "Core Health", val: "Local", icon: ShieldCheck },
            ].map((s, i) => (
              <div key={i}>
          ...
          <div className="h-64 w-full flex items-center justify-center">
            <ResponsiveContainer width="100%" height="100%">
               <PieChart>
                 <Pie data={reserveData} innerRadius={60} outerRadius={80} paddingAngle={5} dataKey="value">
        ...
        <div className="bg-zinc-900 border border-white/5 rounded-3xl p-8">
           <div className="flex items-center gap-3 mb-8">
             ...
             <h3 className="text-xl font-bold uppercase tracking-widest italic">Scenario Lockdown</h3>
           </div>
           ...
           <div className="space-y-6">
              ...
              <div className="p-6 bg-gradient-to-br from-indigo-900/20 to-transparent border border-indigo-500/30 rounded-2xl">
                 ...
                 <p className="text-xs text-slate-400 mb-4 leading-relaxed">Model a private scenario before connecting real providers, brokers, or external capital.</p>
